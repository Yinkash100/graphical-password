    ...
    <div class="signup">
      <form class="form" @submit.prevent="signup">
        ...
        <div  class="form__group">
          ...
          <input v-model="userCredentials.username" id="username" type="text"  class="form__input" placeholder="Username">
          <div v-if="usernameError.status" class="errorMessage">{{ usernameError.error  }}</div>
        </div>
        <div class="form__group">
      ...
      Have no account already? <router-link to="/login">Login</router-link>
    </div>
  ...
  methods: {
    ...
    validateUsername(){
      if(this.userCredentials.username === ''){
        ...
        this.usernameError.error = 'Invalid Username'
        return false
      }
      else {
        return true;
